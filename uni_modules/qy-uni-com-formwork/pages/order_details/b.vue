	...
	<view>
		...
		<view url="/pages/address/address?source=1" class="address-section">
			<view class="order-content">
				...
				<view class="cen" v-for="(item,index) in pro">
					<view class="top">
		...
		<view class="goods-section">
			...
			<view class="g-item" v-for="(item,index) in pro" style="padding-top: 10px;">
				<image src="../../static/logo.png" @click="jump_pro(zxc)"></image>
				<view class="right">
					<text class="title clamp" @click="jump_pro(zxc)">{{item.clamp}}</text>
		...
		<view class="yt-list" v-for="(item,index) in pro">
			<view class="yt-list-cell b-b">
				...
				<text class="cell-tip">{{item.num}}</text>
			</view>
			<view class="yt-list-cell b-b">
			...
			<view class="yt-list-cell b-b">
				...
				<text class="cell-tip">{{item.state}}</text>
			</view>
		</view>
		<view class="btn">
			...
			<button class="btn_1" @click="jump_wuliu(my_order.order_id)">物流</button>
			<view class="btn_1" @click="set_order_finish(my_order.order_id)">确认收货</view>
		</view>
	</view>
</template>
<script>
