...
var _detail = _interopRequireDefault(__webpack_require__(/*! ./pages/service/detail.vue */ 69));
// @ts-ignore
...
/* harmony import */ var _detail_vue_vue_type_template_id_3000c024___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./detail.vue?vue&type=template&id=3000c024& */ 70);
...
try {
  components = {
    ...
    uniRate: function () {
      return __webpack_require__.e(/*! import() | uni_modules/uni-rate/components/uni-rate/uni-rate */ "uni_modules/uni-rate/components/uni-rate/uni-rate").then(__webpack_require__.bind(null, /*! @/uni_modules/uni-rate/components/uni-rate/uni-rate.vue */ 267))
    },
    ...
    uni.request({
      ...
      success: function success(res) {
        if (res.data.code === 200) {
          var _loginInfo$role, _this$item$creator, _res$data$serviceData, _res$data$serviceData2;
